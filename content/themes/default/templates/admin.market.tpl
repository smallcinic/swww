<div class="panel panel-default">
    <div class="panel-heading with-icon">
        {if $sub_view == "categories"}
            <div class="pull-right flip">
                <a href="{$system['system_url']}/admincp/market/add_category" class="btn btn-primary">
                ...
                <table class="table table-striped table-bordered table-hover js_dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button data-toggle="tooltip" data-placement="top" title='{__("Delete")}' class="btn btn-xs btn-danger js_admin-deleter" data-handle="market_category" data-id="{$row['category_id']}">
                                    <i class="fa fa-trash-o"></i>
                                </button>
                                <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/admincp/market/edit_category/{$row['category_id']}" class="btn btn-xs btn-primary">
    ...
    {elseif $sub_view == "edit_category"}
        <div class="panel-body">
            <form class="js_ajax-forms form-horizontal" data-url="admin/market.php?do=edit_category&id={$data['category_id']}">
                <div class="form-group">
                    <label class="col-sm-3 control-label text-left">
                        {__("Name")}
                    </label>
