                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {if $row['place'] == "post"}<i class='fa fa-file-powerpoint-o fa-fw mr5'></i>{__("Post  Page")}{/if}
                                {if $row['place'] == "photo"}<i class='fa fa-picture-o fa-fw mr5'></i>{__("Photo  Page")}{/if}
                                ...
                                {if $row['place'] == "newfeed_1"}<i class='fa fa-newspaper-o fa-fw mr5'></i>{__("Posts Feed")} 1{/if}
                                {if $row['place'] == "newfeed_2"}<i class='fa fa-newspaper-o fa-fw mr5'></i>{__("Posts Feed")} 2{/if}
                                {if $row['place'] == "newfeed_3"}<i class='fa fa-newspaper-o fa-fw mr5'></i>{__("Posts Feed")} 3{/if}
                            ...
                            <td>
                                <button data-toggle="tooltip" data-placement="top" title='{__("Delete")}' class="btn btn-xs btn-danger js_admin-deleter" data-handle="ads" data-id="{$row['ads_id']}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control selectpicker" name="place">
                            ...
                            <option {if $data['place'] == "post"}selected{/if} value="post" data-content="<div class='option'><div class='icon'><i class='fa fa-file-powerpoint-o fa-fw fa-lg'></i></div><div class='text'><b>{__('Post')}</b><br>{__('Appears on the right panel of post page')}.
                            </div></div>">{__("Post")}</option>

                            <option {if $data['place'] == "photo"}selected{/if} value="photo" data-content="<div class='option'><div class='icon'><i class='fa fa-picture-o fa-fw fa-lg'></i></div><div class='text'><b>{__('Photo')}</b><br>{__('Appears on the right panel of photo page')}.
                            ...
                            <option {if $data['place'] == "newfeed_1"}selected{/if} value="newfeed_1" data-content="<div class='option'><div class='icon'><i class='fa fa-newspaper-o fa-fw fa-lg'></i></div><div class='text'><b>{__('Posts Feed')} 1</b><br>{__('Appears after')} {$system['max_results']} {__('posts are loaded, between the posts')}.
                            </div></div>">{__("Posts Feed")} 1</option>

                            <option {if $data['place'] == "newfeed_2"}selected{/if} value="newfeed_2" data-content="<div class='option'><div class='icon'><i class='fa fa-newspaper-o fa-fw fa-lg'></i></div><div class='text'><b>{__('Posts Feed')} 2</b><br>{__('Appears after')} {$system['max_results']*2} {__('posts are loaded, between the posts')}.
                            </div></div>">{__("Posts Feed")} 2</option>

                            <option {if $data['place'] == "newfeed_3"}selected{/if} value="newfeed_3" data-content="<div class='option'><div class='icon'><i class='fa fa-newspaper-o fa-fw fa-lg'></i></div><div class='text'><b>{__('Posts Feed')} 3</b><br>{__('Appears after')} {$system['max_results']*3} {__('posts are loaded, between the posts')}.
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control selectpicker" name="place">
                            ...
                            <option value="post" data-content="<div class='option'><div class='icon'><i class='fa fa-file-powerpoint-o fa-fw fa-lg'></i></div><div class='text'><b>{__('Post')}</b><br>{__('Appears on the right panel of post page')}.
                            </div></div>">{__("Post")}</option>

                            <option value="photo" data-content="<div class='option'><div class='icon'><i class='fa fa-picture-o fa-fw fa-lg'></i></div><div class='text'><b>{__('Photo')}</b><br>{__('Appears on the right panel of photo page')}.
                            </div></div>">{__("Photo")}</option>
                            ...
                            <option value="newfeed_1" data-content="<div class='option'><div class='icon'><i class='fa fa-newspaper-o fa-fw fa-lg'></i></div><div class='text'><b>{__('Posts Feed')} 1</b><br>{__('Appears after')} {$system['max_results']} {__('posts are loaded, between the posts')}.
                            </div></div>">{__("Posts Feed")} 1</option>

                            <option value="newfeed_2" data-content="<div class='option'><div class='icon'><i class='fa fa-newspaper-o fa-fw fa-lg'></i></div><div class='text'><b>{__('Posts Feed')} 2</b><br>{__('Appears after')} {$system['max_results']*2} {__('posts are loaded, between the posts')}.
                            </div></div>">{__("Posts Feed")} 2</option>

                            <option value="newfeed_3" data-content="<div class='option'><div class='icon'><i class='fa fa-newspaper-o fa-fw fa-lg'></i></div><div class='text'><b>{__('Posts Feed')} 3</b><br>{__('Appears after')} {$system['max_results']*3} {__('posts are loaded, between the posts')}.
                            </div></div>">{__("Posts Feed")} 3</option>
