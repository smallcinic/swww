            ...
            <ul class="nav nav-tabs mb20">
                ...
                <li>
                    <a href="#security" data-toggle="tab">
                        <i class="fa fa-shield fa-fw mr5"></i><strong class="pr5">{__("Security")}</strong>
                    </a>
                </li>
                {if $system['packages_enabled']}
                    <li>
                        <a href="#membership" data-toggle="tab">
                            <i class="fa fa-id-card-o fa-fw mr5"></i><strong class="pr5">{__("Membership")}</strong>
                        </a>
                    </li>
                {/if}
            </ul>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="user_gender">
                                    ...
                                    <option {if $data['user_gender'] == "male"}selected{/if} value="male">
                                        {__("Male")}
                                    </option>
                                    <option {if $data['user_gender'] == "female"}selected{/if} value="female">
                                        {__("Female")}
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-sm-9 col-sm-offset-3">
                                ...
                                {if $data['user_subscribed']}
                                    <button type="button" class="btn btn-danger js_admin-deleter" data-handle="user_package" data-id="{$data['user_id']}">
                                        <i class="fa fa-trash-o"></i> {__("Remove Package")}
                                    </button>
                                {/if}
                            </div>
                        </div>
