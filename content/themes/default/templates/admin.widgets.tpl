    ...
    <div class="panel-heading with-icon">
        {if $sub_view == ""}
            <div class="pull-right flip">
                <a href="{$system['system_url']}/admincp/widgets/add" class="btn btn-primary">
                ...
                <table class="table table-striped table-bordered table-hover js_dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button data-toggle="tooltip" data-placement="top" title='{__("Delete")}' class="btn btn-xs btn-danger js_admin-deleter" data-handle="widget" data-id="{$row['widget_id']}">
                                    <i class="fa fa-trash-o"></i>
                                </button>
                                <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/admincp/widgets/edit/{$row['widget_id']}" class="btn btn-xs btn-primary">
