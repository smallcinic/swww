        ...
        <div class="col-md-4 col-md-offset-4">
            ...
            <form class="js_ajax-forms" data-url="core/signup_social.php">
                <div class="form-group">
                    ...
                    <input value="{$user_profile->displayName}" name="first_name" id="first_name" type="text" class="form-control" required autofocus>
                </div>
                <div class="form-group">
                    <label for="last_name">{__("Last name")}</label>
                    <input value="{$user_profile->displayName}" name="last_name" id="last_name" type="text" class="form-control" required autofocus>
                </div>
                <div class="form-group">
                    <label for="username">{__("Username")}</label>
                    <input value="{$user_profile->username}" name="username" id="username" type="text" class="form-control" required>
                </div>
                <div class="form-group">
