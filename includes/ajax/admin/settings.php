...
try {
	...
	switch ($_GET['edit']) {
		...
		case 'features_settings':
		    $_POST['models_enabled'] = (isset($_POST['models_enabled']))? '1' : '0';
			...
			$db->query(sprintf("UPDATE system_options SET 
						...
						profile_notification_enabled = %s ", secure($_POST['models_enabled']),secure($_POST['contact_enabled']), secure($_POST['directory_enabled']), secure($_POST['pages_enabled']), secure($_POST['groups_enabled']), secure($_POST['events_enabled']), secure($_POST['blogs_enabled']), secure($_POST['market_enabled']), secure($_POST['games_enabled']), secure($_POST['daytime_msg_enabled']), secure($_POST['verification_requests']), secure($_POST['profile_notification_enabled']) )) or _error(SQL_ERROR_THROWEN);
			break;
